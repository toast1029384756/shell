...
Singleton {
    ...
    onDndChanged: {
        ...
        if (dnd)
            Toaster.toast(qsTr("Do not disturb enabled"), qsTr("Peace and Quiet"), "do_not_disturb_on");
        else
            Toaster.toast(qsTr("Do not disturb disabled"), qsTr("Oh god"), "do_not_disturb_off");
    }
